...
// Purpose: Test 0 + 0 - negative values 
// Notice the subtle -0 into RAM[1]
// As the test ran successfully, it shows that 
// a negative symbol in front of zéro still doesn't deter the program's correctness. 
